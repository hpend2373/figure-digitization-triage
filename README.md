...
<!-- CURRENT_SCENARIO_COUNT_CORE: 3608 -->
<!-- CURRENT_SCENARIO_COUNT_FULL: 3685 -->
<!-- CURRENT_SCENARIO_COUNT_RASTER_ONLY: 286 -->
<!-- CURRENT_INTAKE_FULL_SCENARIOS: 262 -->

3608 scenarios on main after v9.28 under `requirements-lock.txt`, and 3685 with
...
3894 and 3971. Every raster is pinned there by SHA-256, so a file that is not
...
no secret is green at 3608/3685 rather than red for a reason it cannot fix.
