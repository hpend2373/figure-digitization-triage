# -*- coding: utf-8 -*-
"""Root entry point for sheet/test_merge_counts.py, so CI runs it with the others.

    python3 test_merge_counts.py     # exit 0 = all scenarios pass
...
runpy.run_path(os.path.join(HERE, "sheet", "test_merge_counts.py"), run_name="__main__")
