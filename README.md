...
<!-- CURRENT_PIPELINE_VERSION: 9.26 -->
<!-- CURRENT_SCENARIO_COUNT_CORE: 3572 -->
<!-- CURRENT_SCENARIO_COUNT_FULL: 3643 -->
<!-- CURRENT_SCENARIO_COUNT_RASTER_ONLY: 286 -->
<!-- CURRENT_INTAKE_FULL_SCENARIOS: 251 -->

3572 scenarios on main after v9.26 under `requirements-lock.txt`, and 3643 with
...
3858 and 3929. Every raster is pinned there by SHA-256, so a file that is not
...
no secret is green at 3572/3643 rather than red for a reason it cannot fix.
