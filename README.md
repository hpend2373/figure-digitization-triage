...
<!-- CURRENT_SCENARIO_COUNT_CORE: 3680 -->
<!-- CURRENT_SCENARIO_COUNT_FULL: 3757 -->
<!-- CURRENT_SCENARIO_COUNT_RASTER_ONLY: 286 -->
<!-- CURRENT_INTAKE_FULL_SCENARIOS: 262 -->

3680 scenarios on main under `requirements-lock.txt`, and 3757 with
...
3966 and 4043. Every raster is pinned there by SHA-256, so a file that is not
...
no secret is green at 3680/3757 rather than red for a reason it cannot fix.
