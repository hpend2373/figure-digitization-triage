...
<!-- CURRENT_SCENARIO_COUNT_CORE: 3694 -->
<!-- CURRENT_SCENARIO_COUNT_FULL: 3771 -->
<!-- CURRENT_SCENARIO_COUNT_RASTER_ONLY: 286 -->
<!-- CURRENT_INTAKE_FULL_SCENARIOS: 262 -->

3694 scenarios on main under `requirements-lock.txt`, and 3771 with
...
3980 and 4057. Every raster is pinned there by SHA-256, so a file that is not
...
no secret is green at 3694/3771 rather than red for a reason it cannot fix.
