...
<!-- CURRENT_PIPELINE_VERSION: 9.16 -->
<!-- CURRENT_SCENARIO_COUNT_CORE: 3399 -->
<!-- CURRENT_SCENARIO_COUNT_FULL: 3440 -->
<!-- CURRENT_SCENARIO_COUNT_RASTER_ONLY: 286 -->

3399 scenarios on main after v9.16 under `requirements-lock.txt`, and 3440 with
...
3685 and 3726. Every raster is pinned there by SHA-256, so a file that is not
...
no secret is green at 3399/3440 rather than red for a reason it cannot fix.
