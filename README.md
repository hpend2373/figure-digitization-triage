...
<!-- CURRENT_PIPELINE_VERSION: 9.22 -->
<!-- CURRENT_SCENARIO_COUNT_CORE: 3509 -->
<!-- CURRENT_SCENARIO_COUNT_FULL: 3566 -->
<!-- CURRENT_SCENARIO_COUNT_RASTER_ONLY: 286 -->

3509 scenarios on main after v9.22 under `requirements-lock.txt`, and 3566 with
...
3795 and 3852. Every raster is pinned there by SHA-256, so a file that is not
...
no secret is green at 3509/3566 rather than red for a reason it cannot fix.
