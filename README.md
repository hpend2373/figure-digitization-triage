...
<!-- CURRENT_SCENARIO_COUNT_CORE: 3709 -->
<!-- CURRENT_SCENARIO_COUNT_FULL: 3786 -->
<!-- CURRENT_SCENARIO_COUNT_RASTER_ONLY: 286 -->
<!-- CURRENT_INTAKE_FULL_SCENARIOS: 262 -->

3709 scenarios on main under `requirements-lock.txt`, and 3786 with
...
3995 and 4072. Every raster is pinned there by SHA-256, so a file that is not
...
no secret is green at 3709/3786 rather than red for a reason it cannot fix.
