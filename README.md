...
<!-- CURRENT_PIPELINE_VERSION: 9.21 -->
<!-- CURRENT_SCENARIO_COUNT_CORE: 3509 -->
<!-- CURRENT_SCENARIO_COUNT_FULL: 3559 -->
<!-- CURRENT_SCENARIO_COUNT_RASTER_ONLY: 286 -->

3509 scenarios on main after v9.21 under `requirements-lock.txt`, and 3559 with
...
3795 and 3845. Every raster is pinned there by SHA-256, so a file that is not
...
no secret is green at 3509/3559 rather than red for a reason it cannot fix.
