...
<!-- CURRENT_PIPELINE_VERSION: 9.23 -->
<!-- CURRENT_SCENARIO_COUNT_CORE: 3515 -->
<!-- CURRENT_SCENARIO_COUNT_FULL: 3584 -->
<!-- CURRENT_SCENARIO_COUNT_RASTER_ONLY: 286 -->

3515 scenarios on main after v9.23 under `requirements-lock.txt`, and 3584 with
...
3801 and 3870. Every raster is pinned there by SHA-256, so a file that is not
...
no secret is green at 3515/3584 rather than red for a reason it cannot fix.
