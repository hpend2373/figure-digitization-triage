...
further 278 need the figures. CI fetches them from a private source when
...
<!-- CURRENT_SCENARIO_COUNT_RASTER_ONLY: 278 -->
...
Those two numbers are what a **fresh clone** runs. A further 278 of them need
...
`test_visual_verification` (35) skip those sections
...
3496 and 3537. Every raster is pinned there by SHA-256, so a file that is not
