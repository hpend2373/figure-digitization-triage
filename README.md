...
<!-- CURRENT_SCENARIO_COUNT_CORE: 3675 -->
<!-- CURRENT_SCENARIO_COUNT_FULL: 3752 -->
<!-- CURRENT_SCENARIO_COUNT_RASTER_ONLY: 286 -->
<!-- CURRENT_INTAKE_FULL_SCENARIOS: 262 -->

3675 scenarios on main under `requirements-lock.txt`, and 3752 with
...
3961 and 4038. Every raster is pinned there by SHA-256, so a file that is not
...
no secret is green at 3675/3752 rather than red for a reason it cannot fix.
